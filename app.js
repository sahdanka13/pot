...
const dataload = () => {
  ...
  setTimeout(() => {
    sec_title.innerHTML = " HELLO, THERE.. <br> MY NAME IS<br>SAHDAN";
  ...
  setTimeout(() => {
    sec_title.innerHTML = " HELLO, THERE..<br>MY NAME IS<br>KIAT";
  ...
  setTimeout(() => {
    sec_title.innerHTML = " HELLO, THERE.. <br>MY NAME IS<br>ANDEGA";
    h6_dot[1].classList.remove("head_dots_main");
    h6_dot[2].classList.remove("head_dots_main");
